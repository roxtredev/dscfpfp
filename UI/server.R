...
initialPrediction <- readRDS("./data/start-word-predictionr.RData")
freq2ngram <- readRDS("./data/bigramr.RData")
freq3ngram <- readRDS("./data/trigramr.RData")
freq4ngram <- readRDS("./data/quadgramr.RData")
